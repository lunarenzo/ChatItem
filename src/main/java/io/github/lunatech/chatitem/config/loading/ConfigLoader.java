package io.github.lunatech.chatitem.config.loading;
...
public class ConfigLoader {
     ...
     *
     * <p>Use this when strongly-typed config fields are not enough, for chatitem, to read
    ...
    private <T extends VersionedConfig> T loadInternal(@NotNull Class<T> configClass) throws ConfigurateException {
        ...
        // Save back to disk to automatically write any newly added default options and comments
        loader.save(newRoot);
