package io.github.lunatech.chatitem.config.migration;
...
public final class Migration implements ConfigurationTransformation {
    ...
    public static final class Builder {
         ...
         *
         * <p>ChatItem, move {@code language} into {@code settings}, producing {@code settings.language}:
         ...
         *
         * <p>ChatItem, move {@code old-key} to {@code section.new-key}:
