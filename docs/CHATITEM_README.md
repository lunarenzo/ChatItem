<div align="center" style="display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;">
  <img align="center" style="text-align:center;" src="assets/chatitem_banner.webp" alt="project banner">
...
<a href="https://javadoc.io/doc/io.github.lunatech/chatitem-api">
    <img alt="Javadoc" src="https://img.shields.io/badge/JAVADOC-8A2BE2?style=for-the-badge&labelColor=141417">
</a>

We provide API for developers accessible through [Maven Central](https://central.sonatype.com/artifact/io.github.lunatech/chatitem-api).
...
dependencies {
    compileOnly("io.github.lunatech:chatitem-api:VERSION")
}
```
...
<project>
    <dependencies>
        <dependency>
            ...
            <artifactId>chatitem-api</artifactId>
