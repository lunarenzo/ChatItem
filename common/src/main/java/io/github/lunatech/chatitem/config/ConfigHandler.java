...
import io.github.lunatech.chatitem.config.typeserializer.StringListSerializer;
import io.github.lunatech.chatitem.config.typeserializer.StringObjectMapSerializer;
...
public class ConfigHandler implements Reloadable {
     ...
     */
    public ConfigHandler(AbstractChatItem plugin) {
        this.plugin = plugin;
        this.configDir = plugin.getDataFolder().toPath();
        this.logger = plugin.getComponentLogger();
    }

    public ConfigHandler(AbstractChatItem plugin, Path configDir, Logger logger) {
        this.plugin = plugin;
