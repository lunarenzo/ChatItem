...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/lunatech/ChatItem")
        ...
        scm {
            url.set("https://github.com/lunatech/ChatItem")
            connection.set("scm:git:git://github.com/lunatech/ChatItem.git")
            developerConnection.set("scm:git:ssh://github.com:lunatech/ChatItem.git")
        }
    }
